        ...
        <>
            ...
            <div className='container mt-24 grid grid-cols-2 justify-center items-center mx-auto gap-5'>
                ...
                <div className='login-section flex flex-col justify-between items-start h-[35%]'>
                    ...
                    <h1 className='text-3xl text-center font-semibold text-green-600 '>Log in to E-commerce</h1>
                    ...
                    <form onSubmit={formik.handleSubmit} className="w-[50%]  ">
                        ...
                        <div className='flex flex-row justify-between items-center'>
                            ...
                            <Link to={'/forgetPassword'} className='w-[40%] text-sm text-green-600 text-end'>Forget Password</Link>
                        </div>
                    </form>
